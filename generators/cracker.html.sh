...
cat << EOF
    ...
    <div class="container result">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>
				Packages used for cracking cryptographic functions, ie hashes.</p>
                <br />
                <p>
                    <b>Tool count:</b> <a href="">${CRACKER_COUNT}</a>
