          ...
          <ul class="list-group" itemscope itemtype="https://schema.org/CreativeWork">
            <li class="list-group-item">
              ...
              <table class=download>
                ...
                <tr>
                  <td><a href="https://www.mirrorservice.org/sites/blackarch.org/blackarch/iso/blackarch-linux-live-2020.01.01-x86_64.iso" itemprop="fileFormat" type="application/x-iso9660-image">BlackArch Linux 64 bit Live ISO</a></td>
                  <td itemprop="datePublished">2020.01.01</td>
                  <td><a href="/blackarch/torrent/blackarch-linux-live-2020.01.01-x86_64.iso.torrent" itemprop="fileFormat" type="application/octet-stream">Torrent</a></td>
                  <td>14 GB</td>
                  <td>${LIVE_CHECKSUM}</td>
                </tr>
                <tr>
                  <td><a href="https://www.mirrorservice.org/sites/blackarch.org/blackarch/iso/blackarch-linux-netinst-2020.01.01-x86_64.iso" itemprop="fileFormat" type="application/x-iso9660-image">BlackArch Linux 64 bit Netinstall ISO</a></td>
                  <td itemprop="datePublished">2020.01.01</td>
                  <td><a href="/blackarch/torrent/blackarch-linux-netinst-2020.01.01-x86_64.iso.torrent" itemprop="fileFormat" type="application/octet-stream">Torrent</a></td>
                  <td>491 MB</td>
                  <td>${NET_CHECKSUM}</td>
                </tr>
              </table>
          ...
          <ul class="list-group" itemscope itemtype="https://schema.org/CreativeWork">
            <li class="list-group-item">
              ...
              <table class=download>
                ...
                <tr>
                  <td><a href="https://www.mirrorservice.org/sites/blackarch.org/blackarch/ova/blackarch-linux-2020.01.01.ova" itemprop="fileFormat" type="application/x-iso9660-image">BlackArch Linux 64 bit OVA Image</a></td>
                  <td itemprop="datePublished">2020.01.01</td>
                  <td><a href="/blackarch/torrent/blackarch-linux-2020.01.01.ova.torrent" itemprop="fileFormat" type="application/octet-stream">Torrent</a></td>
                  <td>35 GB</td>
                  <td>${OVA_CHECKSUM}</td>
                </tr>
              </table>
