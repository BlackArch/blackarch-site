            ...
            <li class="list-group-item">
              ...
              <table class=download>
                ...
                <tr>
                  ...
                  <td><!--<a href="/blackarch/torrent/blackarch-linux-live-2018.12.01-x86_64.iso.torrent" itemprop="fileFormat" type="application/octet-stream">-->Torrent (not yet)<!--</a>--></td>
                  <td>11 GB</td>
                  <td>${LIVE_CHECKSUM}</td>
                </tr>
                <tr>
                  ...
                  <td itemprop="datePublished">2018.12.01</td>
                  <td><!--<a href="/blackarch/torrent/blackarch-linux-netinst-2018.12.01-x86_64.iso.torrent" itemprop="fileFormat" type="application/octet-stream">-->Torrent (not yet)<!--</a>--></td>
                  <td>624 MB</td>
                  <td>${NET_CHECKSUM}</td>
                </tr>
              </table>
