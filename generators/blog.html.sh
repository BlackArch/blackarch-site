                ...
                <div class="panel panel-default text-left">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            <h4>New mirror added in Ukraine! <d>07 Mar 2016</d></h4>
                            <hr />
                            <p>
                            We would like to thank <a href="https://forum.wawa-mania.ec/" target="_blank">Dimitri of Wawa-Mania (dimitri@linux.com)</a> for becoming a BlackArch Linux mirror.
                                <br />
                                They are offering the following access: <a href="http://blackarch.wawa-mania.to/" target="_blank">http</a>
                            </p>
