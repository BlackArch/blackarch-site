                ...
                <div class="panel panel-default text-left">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            ...
                            <hr />
                            <p>
                                BlackArch Linux now serves more than 1200 tools. All the tools will be included in the upcoming ISOs. If you want to become a beta tester for the new ISOs
                                simply join our <a href="irc://irc.freenode.net/blackarch">IRC channel<a/> on Freenode.
                            </p>
                            <p>
                                The new BlackArch Linux ISOs will include bugfixes for the current installer. They will be released in a couple of days. <br />
