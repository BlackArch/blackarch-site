...
cat << EOF
    ...
    <div class="container result">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>
Packages that are used for managing physically engineered drones.</p>
                <br />
                <p>
                    <b>Tool count:</b> <a href="">${DRONE_COUNT}</a>
                </p>
