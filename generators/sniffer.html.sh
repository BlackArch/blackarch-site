...
cat << EOF
    ...
    <div class="container result">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>
Packages that involve analyzing network traffic.</p>
                <br />
                <p>
                    <b>Tool count:</b> <a href="">${SNIFFER_COUNT}</a>
                </p>
                <div class="panel panel-default text-left">
                    <div class="panel-heading">
                        <b>BlackArch sniffer</b>
                    </div>
