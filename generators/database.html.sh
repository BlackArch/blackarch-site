...
cat << EOF
    ...
    <div class="container result">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>
				Packages that involve database exploitations on any level.</p>
                <br />
                <p>
                    <b>Tool count:</b> <a href="">${DATABASE_COUNT}</a>
                </p>
                <div class="panel panel-default text-left">
                    <div class="panel-heading">
                        <b>BlackArch database</b>
                    </div>
