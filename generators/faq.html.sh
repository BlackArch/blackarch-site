                   ...
                   <!-- /.panel -->
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse">
                            <div class="panel-body panel-body-faq">
                            You must first get an ISO on the <a href="downloads.html" title="Download blackarch">downloads</a> page and install it by following the instructions of the installation script. You can find a tutorial to show the process step by step at this URL <a href="blackarch-install.html" title="Blackarch install">BlackArch installation</a>. If you encounter any problems and need help, the best place to ask is our <a href="https://matrix.to/#/#BlackArch:matrix.org">Matrix channel</a>.
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseSix" class="panel-collapse collapse">
                            <div class="panel-body panel-body-faq">
                                ...
                                If you still cannot find a solution to your problem, visit our <a href="https://matrix.to/#/#BlackArch:matrix.org">Matrix channel</a> and ask for help. But please be advised, BlackArch users are in different parts of the globe (different time zones). Therefore, be patient. Ask your question and wait for a reply.<br>
                            </div>
                        </div>
                    </div>
                   <!-- /.panel -->
                    <div class="panel panel-default">
                        ...
                        <div id="collapseSeven" class="panel-collapse collapse">
                            <div class="panel-body panel-body-faq">
                                ...
                                If you would like to help us with anything, visit our <a href="https://matrix.to/#/#BlackArch:matrix.org">Matrix channel</a>. Just remember to wait for a reply, we are in different time zones.<br>
                            </div>
                        </div>
                    </div>
                   <!-- /.panel -->
