    ...
    <div class="container result">
        ...
        <div class="row">
            <div class="col-lg-12">
	            ...
	            <h1>automobile</h1> <h2>The list</h2>
                </div>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>
				Packages that are used for tool or work on automobile.</p>
                <br />
                <p>
