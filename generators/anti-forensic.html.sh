cat common/start-anti-forensic
    ...
    <div class="container result">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <br />
                <p>
                    <b>Tool count:</b> <a href="">${AFORENSIC_COUNT}</a>
                </p>
                <div class="panel panel-default text-left">
                    <div class="panel-heading">
                        <b>BlackArch anti-forensic</b>
                    </div>
