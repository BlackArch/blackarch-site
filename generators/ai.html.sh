...
cat << EOF
    ...
    <div class="container result">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p>
				Packages that are used for tool or work on artificial intelligence.</p>
                <br />
                <p>
                    <b>Tool count:</b> <a href="">${AI_COUNT}</a>
